...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency "logstasher", ">= 2.1", "< 4.0"
  spec.add_dependency "opentelemetry-exporter-otlp", ">= 0.25", "< 0.35"
  spec.add_dependency "opentelemetry-instrumentation-all", ">= 0.39.1", "< 0.97.0"
  ...
  spec.add_dependency "sentry-rails", ">= 5.3", "< 8.0"
